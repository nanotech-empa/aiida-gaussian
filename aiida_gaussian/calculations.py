"""
Calculations provided by aiida_gaussian.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.input('metadata.options.parser_name', valid_type=six.string_types, default='gaussian')
        ...
        spec.output('gaussian', valid_type=SinglefileData, help='diff between file1 and file2.')
