...
class GaussianCalculation(CalcJob):
    ...
    def _render_input_string_from_params(cls, param_dict, structure):
        ...
        # assume 0 and 1, if not specified
        charge = param_dict["charge"] if "charge" in param_dict else 0
        mult = param_dict["multiplicity"] if "multiplicity" in param_dict else 1
